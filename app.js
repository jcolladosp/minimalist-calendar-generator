...
function setLanguage(lang) {
    ...
    monthSelect.innerHTML = t.months.map((m, i) => 
...
function handleFile(file) {
    ...
    reader.onload = (event) => {
        ...
        document.getElementById('preview').innerHTML = `<img src="${uploadedImage}" alt="Preview">`;
...
function addHoliday() {
    ...
    const daysInMonth = getDaysInMonth(parseInt(document.getElementById('year').value), month);
...
function renderHolidays() {
    ...
    list.innerHTML = holidays.map(day => 
...
function generatePDF() {
    ...
    const contentStartY = imgY + imgHeight + 12;
    ...
    dayNames.forEach((day, i) => {
        pdf.text(day, calendarStartX + i * cellWidth + cellWidth / 2, calendarStartY, { align: 'center' });
    });
    ...
    pdf.text(t.monthsShort[month], margin, calendarStartY + 5);
